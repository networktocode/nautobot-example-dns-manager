# Generated by Django 3.2.15 on 2022-09-22 00:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ttl', models.PositiveIntegerField(default=3600, validators=[django.core.validators.MinValueValidator(300), django.core.validators.MaxValueValidator(2147483647)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ttl', models.PositiveIntegerField(default=14400, validators=[django.core.validators.MinValueValidator(300), django.core.validators.MaxValueValidator(2147483647)])),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
                ('zone', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='nautobot_example_dns_manager.dnszonemodel')),
            ],
            options={
                'abstract': False,
            },
